...
dtype_mappings = {
    "DTYPE_Z":{'id':0, 
               'summary_dtype':None, 'views':{}, 
               'filters':(), 
               'description':"Unknown to Dave..."
               },
    "DTYPE_MISSING":{'id':0, 
                     'summary_dtype':None, 'views':{'html':no_data_view_html, 'json':no_data_view_json}, 
                     'filters':(), 
                     'description':"Unknown to Dave..."
                     },
    "DTYPE_V":{'id':1, 
    ...
    "DTYPE_BU":{'id':2, 
                'summary_dtype':None, 'views':{'html':int_view_html}, 
                'filters':(), 
    ...
    "DTYPE_F":{'id':10, 
               'summary_dtype':None, 'views':{'html':float_view_html}, 
               'filters':(), 
    ...
    "DTYPE_FC":{'id':12, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Single Precision Real Complex (VAX format)"},
    "DTYPE_DC":{'id':13, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Double Precision Real Complex (VAX format)"},
    "DTYPE_T":{'id':14, 
               'summary_dtype':None, 'views':{'html':text_view_html}, 
               'filters':(), #TODO: length filter
               'description':"Text (8-bit characters)"
               },
    "DTYPE_NU":{'id':15, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Unknown to Dave..."},
    "DTYPE_NL":{'id':16, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Unknown to Dave..."},
    "DTYPE_NLO":{'id':17, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Unknown to Dave..."},
    "DTYPE_NR":{'id':18, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Unknown to Dave..."},
    "DTYPE_NRO":{'id':19, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Unknown to Dave..."},
    "DTYPE_NZ":{'id':20, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Unknown to Dave..."},
    "DTYPE_P":{'id':21, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Unknown to Dave..."},
    "DTYPE_ZI":{'id':22, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Unknown to Dave..."},
    "DTYPE_ZEM":{'id':23, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Unknown to Dave..."},
    "DTYPE_DSC":{'id':24, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Unknown to Dave..."},
    "DTYPE_OU":{'id':25, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Unknown to Dave..."},
    "DTYPE_O":{'id':26, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Unknown to Dave..."},
    "DTYPE_G":{'id':27, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Double Precision Real (VAX G_FLOAT format)"},
    "DTYPE_H":{'id':28, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Unknown to Dave..."},
    "DTYPE_GC":{'id':29, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Double Precision Real Complex (VAX G_FLOAT format)"},
    "DTYPE_HC":{'id':30, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Unknown to Dave..."},
    "DTYPE_CIT":{'id':31, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Unknown to Dave..."},
    "DTYPE_BPV":{'id':32, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Unknown to Dave..."},
    "DTYPE_BLV":{'id':33, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Unknown to Dave..."},
    "DTYPE_VU":{'id':34, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Unknown to Dave..."},
    "DTYPE_ADT":{'id':35, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Unknown to Dave..."},
    "DTYPE_VT":{'id':37, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Unknown to Dave..."},
    "DTYPE_FS":{'id':52, 
                'summary_dtype':None, 'views':{'html':float_view_html}, 
                'filters':(), 
    ...
    "DTYPE_FSC":{'id':54, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Single Precision Real Complex (IEEE frmat)"},
    "DTYPE_FTC":{'id':55, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Double Precision Real (IEEE format)"},
    "DTYPE_IDENT":{'id':191, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Variable Name"},
    "DTYPE_NID":{'id':192, 
                 'summary_dtype':None, 'views':{'html':nodeid_view_html}, 
                 'filters':(), # TODO: follow link filter
                 'description':"Node (ID)"
                 },
    "DTYPE_PATH":{'id':193, 
                  'summary_dtype':None, 'views':{'html':nodepath_view_html}, 
                  'filters':(), # TODO: follow link filter
                  'description':"Node (Path)"
                  },
    "DTYPE_PARAM":{'id':194, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Parameter"},
    "DTYPE_SIGNAL":{'id':195, 
                    'summary_dtype':None, 'views':{'html':signal_view_html, 'bin':signal_view_bin, 'json':signal_view_json}, 
                    'filters':(df.Resample, df.ResampleMinMax, df.DimRange, df.MeanValue), 
                    'description':"Signal"
                    },
    "DTYPE_DIMENSION":{'id':196, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Dimension"},
    "DTYPE_WINDOW":{'id':197, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Window"},
    "DTYPE_SLOPE":{'id':198, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Slope (deprecated?)"},
    "DTYPE_FUNCTION":{'id':199, 
                      'summary_dtype':None, 'views':{'html':function_call_view_html}, 
                      'filters':(), 
                      'description':"Built-in Function Call"
                      },
    "DTYPE_CONGLOM":{'id':200, 
                     'summary_dtype':None, 'views':{'html':conglom_view_html}, 
                     'filters':(), 
                     'description':"Conglomerate/Device"
                     },
    "DTYPE_RANGE":{'id':201, 
                   'summary_dtype':None, 'views':{'html':range_view_html}, 
                   'filters':(), 
                   'description':"Range"
                   },
    "DTYPE_ACTION":{'id':202, 
                    'summary_dtype':None, 'views':{'html':action_view_html}, 
                    'filters':(), 
                    'description':"Action"
                    },
    "DTYPE_DISPATCH":{'id':203, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Dispatch"},
    "DTYPE_PROGRAM":{'id':204, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Program (deprecited?"},
    "DTYPE_ROUTINE":{'id':205, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Routine"},
    "DTYPE_PROCEDURE":{'id':206, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Procedure (deprecated?"},
    "DTYPE_METHOD":{'id':207, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Method"},
    "DTYPE_DEPENDENCY":{'id':208, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Dependency (deprecated?"},
    "DTYPE_CONDITION":{'id':209, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Condition (deprecated?"},
    "DTYPE_EVENT":{'id':210, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Event (deprecated?"},
    "DTYPE_WITH_UNITS":{'id':211, 
                        'summary_dtype':None, 'views':{'html':data_with_units_view_html}, 
                        'filters':(), 
                        'description':"Data with units"
                        },
    "DTYPE_CALL":{'id':212, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"External function call"},
    "DTYPE_WITH_ERROR":{'id':213, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Data with error"},
    "DTYPE_LIST":{'id':214, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Unknown to Dave..."},
    "DTYPE_TUPLE":{'id':215, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Unknown to Dave..."},
    "DTYPE_DICTIONARY":{'id':216, 
                        'summary_dtype':None, 'views':{'json':dictionary_view_json},
                        'filters':(), 
                        'description':"Unknown to Dave..."},
    "DTYPE_NATIVE_DOUBLE":{'id':53, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Unknown to Dave..."},
    "DTYPE_NATIVE_FLOAT":{'id':52, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Unknown to Dave..."},
    "DTYPE_DOUBLE_COMPLEX":{'id':54, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Unknown to Dave..."},
    "DTYPE_DOUBLE":{'id':53, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Unknown to Dave..."},
    "DTYPE_FLOAT_COMPLEX":{'id':54, 'summary_dtype':None, 'views':{}, 'filters':(), 'description':"Unknown to Dave..."},
    "DTYPE_FLOAT":{'id':52,
                   'summary_dtype':'FLOAT', 'views':{'html':float_view_html, 'json':float_view_json}, 
                   'filters':(),
                   'description':"Unknown to Dave..."},
}
...
class MDSPlusDataWrapper(object):
    ...
    def get_view_data(self, request):
        ...
        view_data = {'shot':self.shot,
                     ...
                     'summary_dtype':dtype_mappings[self.filtered_dtype]['summary_dtype'],
