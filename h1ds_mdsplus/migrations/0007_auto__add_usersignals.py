...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UserSignals'
        db.create_table('h1ds_mdsplus_usersignals', (
        ...
        db.send_create_signal('h1ds_mdsplus', ['UserSignals'])


    def backwards(self, orm):
        
        # Deleting model 'UserSignals'
        db.delete_table('h1ds_mdsplus_usersignals')
