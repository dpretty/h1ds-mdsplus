...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('h1ds_mdsplus_usersignal', 'is_fixed_to_shot', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'UserSignal.shot'
        db.add_column('h1ds_mdsplus_usersignal', 'shot', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserSignal.is_fixed_to_shot'
        db.delete_column('h1ds_mdsplus_usersignal', 'is_fixed_to_shot')

        # Deleting field 'UserSignal.shot'
        db.delete_column('h1ds_mdsplus_usersignal', 'shot')
